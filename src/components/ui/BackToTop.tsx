    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="group fixed bottom-6 right-5 z-40 grid h-12 w-12 place-items-center rounded-full border border-white/15 bg-navy-900/80 text-white shadow-[0_10px_36px_-8px_rgb(0_0_0_/_0.7)] backdrop-blur-md transition-colors duration-300 hover:border-brand-500 hover:bg-brand-600 sm:bottom-8 sm:right-8"
        >
